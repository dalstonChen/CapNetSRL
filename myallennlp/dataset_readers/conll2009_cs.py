...
def main():
    data_folder = "/afs/inf.ed.ac.uk/group/project/xchen13/datasets/2009_conll_p1/data/CoNLL2009-ST-Czech/"
    ...
    dev_data = reader.read(data_folder+"CoNLL2009-ST-Czech-development.txt")
